...
export default async function BracketPage() {
  ...
  // Pick matches by official match number (openfootball numbering, same as our DB seed).
  // NOTE: openfootball and ESPN use different match numbers for the same games.
  // Our DB: M91=Brazil/Norway(Jul5), M92=Mexico/England(Jul6), M93=Portugal/Spain(Jul6), M94=USA/Belgium(Jul7)
  //
  // Left side (→ SF M101): Paraguay/France, Canada/Morocco, Portugal/Spain, USA/Belgium
  // Left R32 pairs:  [M74,M77]→M89  [M73,M75]→M90  [M83,M84]→M93  [M81,M82]→M94
  ...
  // Right R32 pairs: [M76,M78]→M91  [M79,M80]→M92  [M86,M88]→M95  [M85,M87]→M96
